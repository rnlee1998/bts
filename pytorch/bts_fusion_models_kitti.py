...
class BtsModel_Fusion(nn.Module):
    def __init__(self, params):
        ...
        checkpoint = torch.load("/mnt/data/liran/TransDepth-main/pytorch/stage1_kitti/densenet-147000-best_rms_2.41944",
                                map_location='cuda:{}'.format(self.params.gpu))
    ...
    def forward(self, x):
        ...
        features_to_fusion = [feature_resnext,feature_resnext]#精度由低到高
